...
### Технические метрики
#### Размер хранилища
1. Репозитории: 330 000 000 * 14.7 Мб = 4851 Тб
...
## 4. Физическая схема
<kbd>
  <img src="/images/physical_diagram_bd.jpg" alt="Физическая схема БД">
</kbd>

### Размеры
| Таблицы  | Значение  | Размер |
| -------|:----------:|:-------:|
| Пользователи | (8 + 64 + 64 + 64)байт * 100 000 000 человек | 20 Гб |
| Репозитории | (8 + 8 + 256 + 8 + 4)байт * 330 000 000 репозиториев | 94 Гб |
| Pull requests | (8 + 8 + 8 + 4)байт * 14 000 000 человек * 96 раз в год | 37.6 Гб/год |
| Issues | (8 + 8 + 8 + 256)байт * 14 000 000 человек * 24 раза в год | 94 Гб/год |
| Комментарии | (8 + 8 + 8 + 256)байт * 14 000 000 человек * 730 раза в год | 2862 Гб/год |
## 5. Технологии
| Технология  | Область применения  | Мотивация |
| -------|:----------:|:-------:|
| Typescript, React | Frontend | Быстро развиваются, большое коммьюнити, надежность |
...
<kbd>
  <img src="/images/regions.jpg" alt="Расположение">
</kbd>

## Kubernetes
| Регион  | Пример | RAM | CPU | Хранилище |
| :----------:|:-------:|:-------:|:-------:|:-------:|
| Америка | 5 нод | 256Гб | 64 ядра | 256 Гб NVMe |
| Европа | 5 нод | 256Гб | 64 ядра | 256 Гб NVMe |
| Африка | 5 нод | 256Гб | 64 ядра | 256 Гб NVMe |
| Азия | 5 нод | 256Гб | 64 ядра | 256 Гб NVMe |

## PostgreSQL Repozitories
| Регион  | Пример | RAM | CPU | Хранилище |
| :----------:|:-------:|:-------:|:-------:|:-------:|
| Америка | 5 шардов + 2 реплики | 128Гб | 64 ядра | 2 NVMe x 2 ТБ RAID 10 |
| Европа | 5 шардов + 2 реплики | 128Гб | 64 ядра | 2 NVMe x 2 ТБ RAID 10 |

## PostgreSQL PR
| Регион  | Пример | RAM | CPU | Хранилище |
| :----------:|:-------:|:-------:|:-------:|:-------:|
| Америка | 2 шарда + 2 реплики | 96Гб | 64 ядра | 8 NVMe x 2 ТБ RAID 10 |
| Европа | 2 шарда + 2 реплики | 96Гб | 64 ядра | 8 NVMe x 2 ТБ RAID 10 |
...
| Регион  | Пример | RAM | CPU | Хранилище |
| :----------:|:-------:|:-------:|:-------:|:-------:|
| Америка | 3 основных + 3 дополнительных | 32Гб | 24 ядра | 64 Гб NVMe |
| Европа | 3 основных + 3 дополнительных | 32Гб | 24 ядра | 64 Гб NVMe |
| Африка | 3 основных + 3 дополнительных | 32Гб | 24 ядра | 64 Гб NVMe |
| Азия | 3 основных + 3 дополнительных | 32Гб | 24 ядра | 64 Гб NVMe |
