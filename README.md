...
| Клонирование репозитория | 21.6 |  |
| Загрузка новых данных из репозитория (git pull) | 486 |  |
| Редактирование репозитория | 810 | |
| Открытие Pull Request | 46.3 |  |
| Открытие Issues | 10.8 |  |
| Добавление комментария | 324 |  |
| Общие значения |  |  |
